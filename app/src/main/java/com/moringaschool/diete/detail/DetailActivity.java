...
public class DetailActivity extends AppCompatActivity  implements DetailView{
    ...
    @BindView(R.id.ingredient) TextView ingredients;

    @BindView(R.id.measure) TextView measures;

    @BindView(R.id.progressBar) ProgressBar progressBar;

    @BindView(R.id.youtube) TextView youtube;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DetailMain main = new DetailMain(this);
        main.getMealById(mealName);
    ...
    void setupColorActionBarIcon(Drawable favoriteItemColor) {
        appBarLayout.addOnOffsetChangedListener((appBarLayout, verticalOffset) -> {
            if ((collapsingToolbarLayout.getHeight() + verticalOffset) < (2 * ViewCompat.getMinimumHeight(collapsingToolbarLayout))) {
                ...
                favoriteItemColor.mutate().setColorFilter(getResources().getColor(R.color.black),
...
progressBar.setVisibility(View.INVISIBLE);
    ...
    public void onErrorLoading(String message) {
        Constants.showDialogMessage(this, "Error", message);
    }
}